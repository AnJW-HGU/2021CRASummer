      ...
      child: Container(
        ...
        child: Text(
            "<이용약관>"
                ...
                "제 1장 총칙\n"
                "제 1조 (목적)\n"
                "이 약관은 “CRA”(이하 “회사”라 합니다)가 제공하는 “스터디투게더”(이하 ‘서비스’라 합니다)를 "
                "회사와 이용계약을 체결한 ‘고객’이 이용함에 있어 필요한 회사와 고객의 권리 및 의무, 기타 제반 사항을 정함을 목적으로 합니다. \n\n"
                ...
                "제 2장 서비스의 이용\n"
                "제 3조 (가입자격)\n"
                "서비스에 가입할 수 있는 자는 Application 이 설치가능한 모든 한동대학교 메일을 가지고 있는 사람입니다.\n\n"

                "제 4조 (서비스 가입)\n"
                "1. “Application 관리자”가 정한 본 약관에 고객이 동의하면 서비스 가입의 효력이 발생합니다.\n"
                "2. “Application 관리자”는 다음 각 호의 고객 가입신청에 대해서는 이를 승낙하지 않을 수 있습니다.\n"
                ...
                "단, 회사의 업무상이나 기술상의 이유로 서비스가 일시 중지될 수 있으며, 운영상의 목적으로 회사가 정한 기간에는 서비스가 일시 중지될 수 있습니다. "
                "이러한 경우 회사는 사전 또는 사후에 이를 공지합니다.\n"
                "2. 위치정보는 관련 기술의 발전에 따라 오차가 발생할 수 있습니다.\n\n"
                ...
                "제 21조 (손해배상)\n"
                "1. 고객의 고의나 과실에 의해 이 약관의 규정을 위반함으로 인하여 회사에 손해가 발생하게 되는 경우, 이 약관을 위반한 고객은 회사에 발생하는 모든 손해를 배상하여야 합니다.\n"
                "2. 고객이 서비스를 이용함에 있어 행한 불법행위나 고객의 고의나 과실에 의해 이 약관 위반행위로 인하여 "
                "회사가 당해 고객 이외의 제3자로부터 손해배상청구 또는 소송을 비롯한 각종 이의제기를 받는 경우 "
                "당해 고객은 그로 인하여 회사에 발생한 손해를 배상하여야 합니다.\n"
                "3.  회사가 위치정보의 보호 및 이용 등에 관한 법률 제 15조 내지 제26조의 규정을 위반한 행위 "
                "혹은 회사가 제공하는 서비스로 인하여 고객에게 손해가 발생한 경우, "
                "회사가 고의 또는 과실 없음을 입증하지 아니하면, 고객의 손해에 대하여 책임을 부담합니다.\n\n"

                "제 22조 (면책사항)\n"
                "1. 회사는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를 제공할 수 없는 경우에는 서비스 제공에 관한 책임이 면제됩니다.\n"
                "2. 회사는 고객의 귀책사유로 인한 서비스의 이용장애에 대하여 책임을 지지 않습니다.\n"
                "3. 회사는 고객이 서비스를 이용하여 기대하는 수익을 상실한 것에 대하여 책임을 지지 않으며, "
                "그 밖에 서비스를 통하여 얻은 자료로 인한 손해 등에 대하여도 책임을 지지 않습니다.\n"
                "4. 회사에서 제공하는 서비스 및 서비스를 이용하여 얻은 정보에 대한 최종판단은 고객이 직접 하여야 하고, "
                "그에 따른 책임은 전적으로 고객 자신에게 있으며, "
                "회사는 그로 인하여 발생하는 손해에 대해서 책임을 부담하지 않습니다. \n"
                "5. 회사의 업무상 또는 기술상의 장애로 인하여 서비스를 개시하지 못하는 경우 회사는 공지사항 등에 이를 공지하거나 E-mail 등의 방법으로 고객에게 통지합니다. "
                "단, 회사가 통제할 수 없는 사유로 인하여 사전 공지가 불가능한 경우에는 사후에 공지합니다. \n\n"

                "제 23조 (분쟁의 해결 및 관할법원)\n"
                "1. 서비스 이용과 관련하여 회사와 고객 사이에 분쟁이 발생한 경우, 회사와 고객은 분쟁의 해결을 위해 성실히 협의합니다.\n"
                "2. 제1항의 협의에서도 분쟁이 해결되지 않을 경우 양 당사자는 정보통신망 이용촉진 및 정보보호 등에 관한 법률 "
                "제33조의 규정에 의한 개인정보분쟁조정위원회에 분쟁조정을 신청할 수 있습니다.\n",
                style: TextStyle(
                  fontFamily: "Barun",
                  fontSize: 14.sp,
